...
- For example, if your original array is `[2, 8, 9, 48, 8, 22, -12, 2]`, the output should look like this:
...
- Por ejemplo, si tu array original es `[2, 8, 9, 48, 8, 22, -12, 2]`, el resultado debería verse de la siguiente manera:
